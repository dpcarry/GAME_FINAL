...
void LevelA::initialise()
{
    ...
    std::vector<GLuint> bancho_texture_ids = {
    Utility::load_texture("assets/bancho_idle_lhs.png"),   // IDLE lhs spritesheet
    Utility::load_texture("assets/bancho_idle_rhs.png"),   // IDLE rhs spritesheet
    Utility::load_texture("assets/bancho_idle_rhs.png"),   // double punch lhs spritesheet
    Utility::load_texture("assets/bancho_idle_rhs.png"),   // double punch rhs spritesheet
    ...
    Utility::load_texture("assets/bancho_walk_left.png"),  // WALK LEFT spritesheet
    Utility::load_texture("assets/bancho_walk_right.png"),  // WALK RIGHT spritesheet
    ...
    Utility::load_texture("assets/bancho_idle_rhs.png"),  // defend lhs spritesheet
    Utility::load_texture("assets/bancho_idle_rhs.png"),  // defend rhs spritesheet
    Utility::load_texture("assets/bancho_onhit_lhs.png"),   // onhit lhs spritesheet
    Utility::load_texture("assets/bancho_onhit_rhs.png"),   // onhit rhs spritesheet
    ...
    std::vector<std::vector<int>> bancho_animations = {
        {0, 1, 2, 3, 4, 5, 6},       // IDLE lhs animation frames
        {6, 5, 4, 3, 2, 1, 0},        // IDLE rhs animation frames
        {6, 5, 4, 3, 2, 1, 0},         
        {6, 5, 4, 3, 2, 1, 0},        
        {0, 1}, 
        {1, 0},
    ...
    m_game_state.enemies[0] = Entity(bancho_texture_ids, 1.0f, 1.0f, 2.0f, bancho_animations, ENEMY, BANCHO, IDLE);
...
void LevelA::update(float delta_time)
{
    ...
    if ((m_game_state.enemies[0].get_is_active() == false)) m_game_state.next_scene_id = 2;
}
